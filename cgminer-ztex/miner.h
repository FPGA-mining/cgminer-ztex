...
static inline void swab512(void *dest_p, const void *src_p)
{
	uint32_t *dest = dest_p;
	const uint32_t *src = src_p;

	dest[0] = swab32(src[15]);
	dest[1] = swab32(src[14]);
	dest[2] = swab32(src[13]);
	dest[3] = swab32(src[12]);
	dest[4] = swab32(src[11]);
	dest[5] = swab32(src[10]);
	dest[6] = swab32(src[9]);
	dest[7] = swab32(src[8]);
	dest[8] = swab32(src[7]);
	dest[9] = swab32(src[6]);
	dest[10] = swab32(src[5]);
	dest[11] = swab32(src[4]);
	dest[12] = swab32(src[3]);
	dest[13] = swab32(src[2]);
	dest[14] = swab32(src[1]);
	dest[15] = swab32(src[0]);
}
...
struct work {
	...
	unsigned char	midstate[64];	// Increased For Whirlpool Algo (512 bits)
